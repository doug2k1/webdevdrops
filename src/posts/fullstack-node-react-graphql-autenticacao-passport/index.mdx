---
title: 'Fullstack com Node.js, React e GraphQL - 7: Autenticação com Passport.js'
date: '2019-05-02'
categories:
  - 'Full Stack'
tags:
  ...
  - 'passportjs'
  - 'react'
coverImage: '/fullstack-node-react-graphql-autenticacao-passport/images/fullstack-node-react-graphql-7.jpg'
---
...
<PostImage
  src="/fullstack-node-react-graphql-autenticacao-passport/images/fullstack-node-react-graphql-7-1024x558.jpg"
  width="1024"
  height="558"
  alt=""
/>
...
3. O **Google** redireciona de volta para a nossa app em “/auth/google/callback”, onde o **Passport** reconhece o usuário e guarda sua informação na sessão.
4. Nossa app redireciona para a *home*, com o usuário já logado.
...
Você precisa ter uma conta no **Google** e acessar o dashboard do **Google APIs**: [https://console.developers.google.com/apis/dashboard](https://console.developers.google.com/apis/dashboard)

Lá você precisa criar um novo projeto, e com este projeto selecionado, acessar a área de *Credenciais*:

<PostImage
  src="/fullstack-node-react-graphql-autenticacao-passport/images/google-api-credenciais.png"
  width="684"
  height="399"
  alt=""
/>
...
Vamos criar um *middleware* do **Express** para proteger as rotas que necessitam autenticação:
...
Vamos proteger os endpoints do **GraphQL**. No *src/setupGraphQL.js* adicionamos a chamada ao `authMiddleware` nos endpoints de consulta e do **GraphiQL**:
...
Habilitamos o **EJS** no **Express** e configuramos a rota inicial para retornar a view `index`, recebendo os dados do usuário. Adicionamos no *src/index.js*:
...
O código do projeto até este ponto está em: [https://github.com/doug2k1/my-money/tree/v6.0.0](https://github.com/doug2k1/my-money/tree/v6.0.0)
