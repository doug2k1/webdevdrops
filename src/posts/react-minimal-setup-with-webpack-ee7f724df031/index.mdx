...
date: '2017-08-21'
coverImage: '/react-minimal-setup-with-webpack-ee7f724df031/images/react-minimal-1.jpg'
language: en
translations:
  pt-BR: react-setup-minimo-webpack
---

In this post I’ll show a minimal Webpack setup to start working with React.

<PostImage
  src="/react-minimal-setup-with-webpack-ee7f724df031/images/react-minimal-1.jpg"
  width="1180"
  height="944"
  alt=""
/>
