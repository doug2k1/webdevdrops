...
Resolvi informar o problema ao **Procon**. Fiz via site mesmo. Descrevi a situação, com todos os dados, datas, valores, etc. e que desejava ter meu dinheiro de volta. Eles analisaram e registraram uma **CIP** (Carta de Informação Preliminar). O próprio Procon enviou uma cópia desta carta para Samsung (via e-mail).
