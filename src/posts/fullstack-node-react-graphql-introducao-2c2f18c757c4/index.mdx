---
title: 'Full Stack com Node.js, React e GraphQL  - 1: Introdução'
date: '2018-03-05'
categories:
  - 'Full Stack'
tags:
  - 'nodejs'
  - 'react'
coverImage: '/fullstack-node-react-graphql-introducao-2c2f18c757c4/images/fullstack-1-1.png'
---

E aí, pessoal! Nesta série de posts irei documentar o desenvolvimento de uma aplicação web, backend e frontend (full stack), do zero até produção, envolvendo tecnologias como **Node.js**, **Sequelize**, **React**, **GraphQL** e **Apollo**.

<PostImage
  src="/fullstack-node-react-graphql-introducao-2c2f18c757c4/images/fullstack-1-1-1024x558.png"
  width="1024"
  height="558"
  alt=""
/>
...
<PostImage
  src="/fullstack-node-react-graphql-introducao-2c2f18c757c4/images/fullstack-1-2.png"
  width="268"
  height="379"
  alt=""
/>
...
- **[8: Setup frontend com React e TypeScript](/fullstack-node-js-react-graphql-typescript/)** (publicado)
- **[9: Construção do frontend](/fullstack-nodejs-react-graphql-9-material-ui-recharts/)** (publicado)
- **[10: Integração fronten/backend com Apollo Client](/fullstack-node-js-react-graphql-apollo-client/)** (publicado)
- **[11: Testes no frontend](/fullstack-11-testes-frontend-react-testing-library/)** (publicado)
- **[12: Deploy em produção](/fullstack-nodejs-react-graphql-12-deploy-producao-heroku/)** (publicado)
- 13: Cadastro de dados
