...
tags:
  - 'webpack'
coverImage: '/webpack-sem-medo-parte-3-plugins-e-dev-server-86b6e003657c/images/webpack-sem-medo.jpg'
---
...
<PostImage
  src="/webpack-sem-medo-parte-3-plugins-e-dev-server-86b6e003657c/images/webpack-3.png"
  width="877"
  height="414"
  alt=""
/>
...
<PostImage
  src="/webpack-sem-medo-parte-3-plugins-e-dev-server-86b6e003657c/images/webpack-3-1.png"
  width="277"
  height="124"
  alt=""
/>
...
<PostImage
  src="/webpack-sem-medo-parte-3-plugins-e-dev-server-86b6e003657c/images/webpack-3-2.png"
  width="319"
  height="125"
  alt=""
/>
...
Com isso, basta rodar `npm start` e acessar o endereço que ele mostra no terminal (por padrão é **[http://localhost:8080](http://localhost:8080)**). Agora basta manter esta página aberta e ir alterando os arquivos. O webpack + webpack-dev-server irão reconstruir o bundle e atualizar a página automaticamente.
...
Feedback, críticas, dúvidas? Comentem aqui, ou me pinguem la no [Twitter @webdevdrops](https://twitter.com/webdevdrops)!
