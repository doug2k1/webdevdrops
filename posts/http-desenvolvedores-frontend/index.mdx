...
tags:
  - 'http'
coverImage: '/http-desenvolvedores-frontend/images/http.jpg'
translations:
  en: http-primer-for-frontend-developers-f091a2070637
---
...
<PostImage
  src="/http-desenvolvedores-frontend/images/http-br-1-1024x644.png"
  width="1024"
  height="644"
  alt=""
/>
...
<PostImage
  src="/http-desenvolvedores-frontend/images/http-br-2-1024x461.png"
  width="1024"
  height="461"
  alt=""
/>
...
<PostImage
  src="/http-desenvolvedores-frontend/images/http-br-3-1024x467.png"
  width="1024"
  height="467"
  alt=""
/>
...
[https://pt.wikipedia.org/wiki/Lista_de_c%C3%B3digos_de_estado_HTTP](https://pt.wikipedia.org/wiki/Lista_de_c%C3%B3digos_de_estado_HTTP)
...
fetch('https://api.github.com/nonexistent-uri').then((response) => {
  if (response.ok) {
...
- [https://pt.wikipedia.org/wiki/Hypertext_Transfer_Protocol](https://pt.wikipedia.org/wiki/Hypertext_Transfer_Protocol)
