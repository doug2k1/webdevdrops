---
title: 'Fullstack com Node.js, React e GraphQL  - 2: Setup inicial e servidor Node.js com Express'
date: '2018-03-07'
categories:
  - 'Full Stack'
tags:
  ...
  - 'nodejs'
  - 'react'
coverImage: '/fullstack-node-react-graphql-express-b551b1a25ef3/images/fullstack-2-1.png'
---
...
<PostImage
  src="/fullstack-node-react-graphql-express-b551b1a25ef3/images/fullstack-2-1-1024x558.png"
  width="1024"
  height="558"
  alt=""
/>
...
O *.gitignore* lista os arquivos e pastas que serão ignorados pelo Git. Podemos começar colocando `node_modules` aí. O *.npmrc* define opções para o npm. No meu caso só coloquei `progress=false` para desabilitar a barra de progresso na instalação de módulos e agilizar um pouco o processo.
...
Por fim adicionamos um arquivo HTML em _public/index.html_. Como o servidor está servindo o que estiver na pasta _public_, ao acessar **http://localhost:5000** ele vai servir o _index.html_.

Agora é só executar `npm start` e acessar **http://localhost:5000**:

<PostImage
  src="/fullstack-node-react-graphql-express-b551b1a25ef3/images/fullstack-2-2.png"
  width="420"
  height="258"
  alt=""
/>
